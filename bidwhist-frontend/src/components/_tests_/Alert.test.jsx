...
describe('Alert component', () => {
  test('renders the message and correct type class', () => {
    render(<Alert message="Success!" type="persist" onClose={() => {}} />);
  ...
  test('calls onClose when close button is clicked', () => {
    const onClose = vi.fn();
    render(<Alert message="Click to close" type="persist" onClose={onClose} />);
  ...
  test('resets timer when message changes', () => {
    const onClose = vi.fn();
    const { rerender } = render(<Alert message="First message" type="success" onClose={onClose} />);
  ...
  test('auto-dismisses after 5 seconds for success alert', () => {
    const onClose = vi.fn();
    render(<Alert message="Auto close" type="success" onClose={onClose} />);
