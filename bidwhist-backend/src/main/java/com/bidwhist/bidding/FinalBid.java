...
/**
 * Represents a finalized bid in the game. Includes bid value (4–7), type
 * (Uptown or Downtown), optional suit, and No-Trump status.
 */
public class FinalBid {
    ...
    /**
     * Constructs a finalized bid using an InitialBid as a base. Throws error if
     * a non-No bid is missing a suit.
     */
